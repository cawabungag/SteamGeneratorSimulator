...
namespace OPCClientInterface
{
	...
	public class ClientLogIn
	{
		...
		public bool CertificateLogin(string CertificateFileName, string PassWord)
		{
			try
			{
				X509Certificate2 certificate = new X509Certificate2(CertificateFileName, PassWord,
		...
		public void SendNode(WriteValue valueToWrite)
		{
			Debug.Log($"send node: {valueToWrite}");
		}
	}
}